...
public class EntryPoint {
    public static void main(final String[] args) {
        ...
        try {
            UIManager.setLookAndFeel(new org.netbeans.swing.laf.dark.DarkMetalLookAndFeel());
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        ...
        try { 
            InputStream in = Thread.currentThread().getContextClassLoader().getResourceAsStream("cacerts.jks");
            ...
            //System.setProperty("javax.net.ssl.trustStore", in);
