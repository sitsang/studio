...
public class SettingsDefaults {
    ...
    // Caret color
    public static final Color defaultCaretColor = Color.WHITE;
   ...
   // public static Font defaultFont = new Font( "Monospaced", Font.PLAIN, defaultFontSize); // NOI18N    
    public static final Color defaultForeColor = Color.WHITE;
    public static Color defaultBackColor;
    public static Coloring defaultColoring;
    public static final void init()
    {
        defaultBackColor= Config.getInstance().getColorForToken("BACKGROUND", new Color(12, 21, 33));//Color.white;
        defaultColoring= new Coloring(defaultFont, defaultForeColor, defaultBackColor);
    }
    static{init();}
    // line number coloring
    public static final Color defaultLineNumberForeColor = Color.WHITE;
    public static final Color defaultLineNumberBackColor = new Color(18, 30, 49);
    ...
    public static final Color defaultTextLimitLineColor = Color.BLACK;
    public static final Integer defaultTextLimitWidth = new Integer(120);
    ...
    public static final Color defaultCaretColorInsertMode = Color.white;
    public static final Color defaultCaretColorOvwerwriteMode = Color.white;
