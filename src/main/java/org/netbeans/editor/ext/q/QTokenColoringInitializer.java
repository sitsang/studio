...
class QTokenColoringInitializer extends SettingsUtil.TokenColoringInitializer
{
    ...
    public QTokenColoringInitializer()
    {
        ...
        EOL_COMMENT_Coloring=buildColoring("EOLCOMMENT", italicFont, Color.LIGHT_GRAY);
        ...
        IDENTIFIER_Coloring=buildColoring("IDENTIFIER", SettingsDefaults.defaultFont,new Color(229,219,116));
        OPERATOR_Coloring=buildColoring("OPERATOR", SettingsDefaults.defaultFont,Color.WHITE);
        BOOLEAN_Coloring=buildColoring("BOOLEAN", SettingsDefaults.defaultFont,new Color(51,204,255));
        
        BYTE_Coloring=buildColoring("BYTE",SettingsDefaults.defaultFont,new Color(165,129,218));
        SHORT_Coloring=buildColoring("SHORT",SettingsDefaults.defaultFont,new Color(165,129,218));
        LONG_Coloring=buildColoring("LONG",SettingsDefaults.defaultFont,new Color(165,129,218));
        REAL_Coloring=buildColoring("REAL",SettingsDefaults.defaultFont,new Color(165,129,218));
        INTEGER_Coloring=buildColoring("INTEGER",SettingsDefaults.defaultFont,new Color(165,129,218));
        FLOAT_Coloring=buildColoring("FLOAT",SettingsDefaults.defaultFont,new Color(165,129,218));
        
        TIMESTAMP_Coloring=buildColoring("TIMESTAMP",SettingsDefaults.defaultFont,new Color(255,133,40));
        TIMESPAN_Coloring=buildColoring("TIMESPAN",SettingsDefaults.defaultFont,new Color(255,133,40));
        DATETIME_Coloring=buildColoring("DATETIME",SettingsDefaults.defaultFont,new Color(255,133,40));
        DATE_Coloring=buildColoring("DATE",SettingsDefaults.defaultFont,new Color(255,133,40));
        MONTH_Coloring=buildColoring("MONTH",SettingsDefaults.defaultFont,new Color(255,133,40));
        MINUTE_Coloring=buildColoring("MINUTE",SettingsDefaults.defaultFont,new Color(255,133,40));
        SECOND_Coloring=buildColoring("SECOND",SettingsDefaults.defaultFont,new Color(255,133,40));
        TIME_Coloring=buildColoring("TIME",SettingsDefaults.defaultFont,new Color(255,133,40));
        ...
        SYMBOL_Coloring=buildColoring("SYMBOL",SettingsDefaults.defaultFont,new Color(249,39,108));
        KEYWORD_Coloring=buildColoring("KEYWORD", boldFont,new Color(102,215,239));
        ...
        WHITESPACE_Coloring=buildColoring("WHITESPACE", SettingsDefaults.defaultFont,Color.WHITE);
        DEFAULT_Coloring=buildColoring("DEFAULT", SettingsDefaults.defaultFont,Color.WHITE);
    }
